...
//  since we recieve both edemailmsg and adpasdmsg from loginadmin_server_page.php ,now we check 
...
<div class="row"><h4><?php echo $msg?></h4></div>
            <div class="row">
                ...
                <!-- inside the class="row" of bootstrap we have 12 columns , 
                here we take 6 columns for each login and admin -->
